### Develop Covid 19 dashboard according to Tamplate. Make the necessary changes, giving it a new look. Using the acquired knowledge to improve the Dashboard in Angular. Use link for data update purposes as below: ###
* [API data path](https://retoolapi.dev/Pgr5DD/cases_brasil)
